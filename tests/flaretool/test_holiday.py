...
class JapaneseHolidaysTest(unittest.TestCase):
    ...
    def test_is_respect_for_the_aged_day(self):
        ...
        self.assertFalse(
            self.holidays_online.is_respect_for_the_aged_day(date))
    ...
    def test_is_additional_holiday(self):
        ...
        self.assertEqual(self.holidays_online.get_holiday_name(
            date), "Additional Holiday")
    ...
    def test_week_day(self):
        ...
        self.assertEqual(self.holidays_online.week_day(
            date, 2, 1), expected_date)
    ...
    def test__to_date(self):
        ...
        self.assertEqual(self.holidays_online.to_date(
            datetime_value), expected_date)
    ...
    def test_get_last_day(self):
        ...
        self.assertEqual(
            self.holidays_online.get_last_day(date), expected_date)
    ...
    def test_get_holiday_name(self):
        ...
        self.assertEqual(
            self.holidays_online.get_holiday_name(date), expected_name)
    ...
    def test_get_rest_days_in_range(self):
        ...
        self.assertEqual(self.holidays_online.get_rest_days_in_range(
            start_date, end_date), expected_rest_days)
        ...
        self.assertEqual(
            self.holidays_online.get_rest_days_in_range(
                start_date, end_date),
            expected_rest_days,
        )
    ...
    def test_get_business_date_range(self):
        ...
        self.assertEqual(self.holidays_online.get_business_date_range(
            start_date, end_date), expected_business_days)
    ...
    def test_get_first_business_day(self):
        ...
        self.assertEqual(self.holidays_online.get_first_business_day(
            date), expected_last_business_day)
    ...
    def test_get_last_business_day(self):
        ...
        self.assertEqual(self.holidays.get_last_business_day(
            date), expected_last_business_day)
        self.assertEqual(self.holidays_online.get_last_business_day(
            date), expected_last_business_day)
