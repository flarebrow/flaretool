...
from flaretool.funcs.amazon import *
...
class FuncsTest(unittest.TestCase):
    def setUp(self):
        ...
        self.patcher = patch("socket.create_connection", self.mock_create_connection)
        self.patcher.start()
    ...
    def test_yamato(self, mock_get):
        ...
        response_data = {"result": [{"status": "Delivered"}, {"status": "In Transit"}]}
